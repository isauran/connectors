...
| WASM-15 | Разработка Go SDK для упрощения написания бизнес-логики | In Progress | Создание пакета sdk для инкапсуляции WASM-импортов, ввода-вывода и автоматического управления шагами |
